...
public class ParkingLot {
	...
	public ParkingLot(int capacity) {
		...
		if (capacity < 0) {
			...
			throw new IndexOutOfBoundsException("Capacity is out of bound");
		}
...
//		}
		if(c == null) {
			...
			throw new IndexOutOfBoundsException("Timestamp cannot be less than zero.");
		}
		Spot carToBeParked = new Spot(c,timestamp);
		occupancy.add(carToBeParked);
	}
